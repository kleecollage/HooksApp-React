import { getTasksInititalState, taskReducer } from '@/05-useReducer/reducer/tasks.reducer';
...
export const TasksApp = () => {
  ...
  return (
    <div className="min-h-screen bg-liear-to-br from-slate-50 to-slate-100 p-4">
